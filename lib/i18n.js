...
const STRINGS = {
  ...
  uz: {
    ...
    sidesOfShape:      'Bu shaklning nechta tomoni bor?',
    sayShapeNamesHint: 'Har bir shaklning nomini ovoz chiqarib ayt. Tayyor bo‘lsang, tugmani bos.',
  ...
  en: {
    ...
    sidesOfShape:      'How many sides does this shape have?',
    sayShapeNamesHint: 'Say the name of each shape out loud. Tap the button when you’re done.',
